...
public class SpreeAssertCart_PageFactory extends BaseClass {

    @Test
    public void assertCartValue() throws IOException {
        //Login
        LoginPage loginpage = new LoginPage(driver);
        loginpage.login("user6@user.com","12345678");
        ...
        checkout.addBillingAddress("Jaya","Siri","Rnagar","Bangalore","Alaska","56567","United States of America","87853673730");
